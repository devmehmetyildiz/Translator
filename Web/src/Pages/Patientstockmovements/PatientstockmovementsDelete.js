...
export default class PatientstockmovementsDelete extends Component {
  render() {
    const { Profile, Patientstockmovements, DeletePatientstockmovements, handleDeletemodal, handleSelectedPatientstockmovement } = this.props
    const { isDeletemodalopen, selected_record } = Patientstockmovements
    return (
      <Modal
      ...
      >
        ...
        <Modal.Actions>
          ...
          <Button
            ...
            icon='checkmark'
            onClick={() => {
              DeletePatientstockmovements(selected_record)
              handleDeletemodal(false)
              handleSelectedPatientstockmovement({})
            }}
            positive
