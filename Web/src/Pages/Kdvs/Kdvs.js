...
export default class Kdvs extends Component {
    ...
    render() {
        ...
        const { Kdvs, Profile, handleSelectedKdv, handleDeletemodal } = this.props
        ...
        const Columns = [
            ...
            { Header: Literals.Columns.Percent[Profile.Language], accessor: 'Percent', sortable: true, canGroupBy: true, canFilter: true },
